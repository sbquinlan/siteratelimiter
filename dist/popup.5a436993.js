...
const Popup = ()=>{
    ...
    _hooks.useEffect(()=>{
        _webextensionPolyfillDefault.default.tabs.getCurrent().then(setTab, setError);
    });
    return(/*#__PURE__*/ _preact.h("div", {
        ...
        __self: undefined
    }, "Current tab: ", tab == null ? "true" : "false", " ", error == null ? "true" : "false", " ")));
};
...
//# sourceMappingURL=popup.5a436993.js.map
