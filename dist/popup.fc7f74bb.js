...
const Popup = ()=>{
    const [sites, setSites] = _hooks.useState({
    });
    _hooks.useEffect(()=>{
        _webextensionPolyfillDefault.default.storage.sync.get('sites').then(({ sites: sites1  })=>setSites(sites1)
        );
    });
    return(/*#__PURE__*/ _preact.h("ul", {
        __source: {
        ...
        if (key == '_today') return null;
        return(/*#__PURE__*/ _preact.h("li", {
            __source: {
                fileName: "/Users/squinlan/Documents/sitetimer/source/popup.js",
                lineNumber: 20
            },
...
},{"preact":"1xW1m","preact/hooks":"ZVgFz","webextension-polyfill":"59onB","@parcel/transformer-js/src/esmodule-helpers.js":"omrdF"}],"1xW1m":[function(require,module,exports) {
var n, l, u, t, i, o, r = {
...
},{"preact":"1xW1m"}],"59onB":[function(require,module,exports) {
...
//# sourceMappingURL=popup.fc7f74bb.js.map
