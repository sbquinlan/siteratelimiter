...
const Popup = ()=>{
    ...
    _hooks.useEffect(()=>{
        _webextensionPolyfillDefault.default.tabs.getCurrent().then((tab1, error1)=>{
            setTab(tab1);
            setError(window.document);
        });
    });
    return(/*#__PURE__*/ _preact.h("div", {
        ...
        __self: undefined
    }, tab == null ? "true" : "false"), /*#__PURE__*/ _preact.h("h3", {
        __source: {
            fileName: "/Users/squinlan/Documents/sitetimer/source/popup.js",
            lineNumber: 21
        },
        __self: undefined
    }, error == null ? "true" : error.location)));
};
...
//# sourceMappingURL=popup.9bb44c4b.js.map
